...
const SUBCATEGORY = "Снукер";
const BASE_URL = "https://billiard-partner.com";
const PAGE_URL = BASE_URL + "/bilyardni-stoli/bilyardnye-stoly-dlya-snukera/";
...
async function parseSnooker() {
  ...
  fs.writeFileSync("snooker-products.csv", csv, "utf8");
  console.log("Готово! Дані збережено у snooker-products.csv");
}

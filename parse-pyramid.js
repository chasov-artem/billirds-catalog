...
const SUBCATEGORY = "Піраміда";
const BASE_URL = "https://billiard-partner.com";
const PAGE_URL =
  BASE_URL + "/bilyardni-stoli/bilyardnye-stoly-dlya-russkoy-piramidy/";
...
async function parsePyramid() {
  ...
  fs.writeFileSync("pyramid-products.csv", csv, "utf8");
  console.log("Готово! Дані збережено у pyramid-products.csv");
}

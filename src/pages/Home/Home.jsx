  ...
  return (
    <Fade in={true} timeout={800}>
      <Box className={styles.home}>
        <SEOHead
          title="Купити більярдний стіл у Дніпрі | Більярдне сукно, киї, кулі | Більярд Сервіс"
          description="Купити більярдний стіл у Дніпрі. Більярдне сукно, більярдні киї, кулі, аксесуари для більярду. Монтаж та обслуговування більярдних столів. Доставка по Україні. Більярд Сервіс з 1996 року."
          keywords="купити більярдний стіл, більярдний стіл Дніпро, більярдне сукно, більярдні киї, більярдні кулі, аксесуари для більярду, монтаж більярдних столів, перетяжка сукна, більярд сервіс, більярдний стіл купити, сукно для більярду, кий для більярду, кулі для більярду, більярдний інвентар, більярдне обладнання, збірка більярдного столу, ремонт більярдного столу, більярдний клуб, більярдний зал"
          ogTitle="Купити більярдний стіл у Дніпрі | Більярдне сукно, киї, кулі"
          ogDescription="Купити більярдний стіл у Дніпрі. Більярдне сукно, киї, кулі, аксесуари. Монтаж та обслуговування. Доставка по Україні."
          canonical="https://www.billiard-servis.com/"
        />
        <StructuredData
          id="business"
          data={{
            ...
            name: "БІЛЬЯРД СЕРВІС",
            description:
              "Купити більярдний стіл у Дніпрі. Продаж, монтаж та обслуговування більярдних столів, більярдного сукна, київ, куль та аксесуарів з 1996 року",
        ...
        <Box className={styles.heroSection}>
          ...
          <Container maxWidth="lg">
            <Box className={styles.heroContent}>
              ...
              >
                Купити більярдний стіл у Дніпрі
              </Typography>
              <Typography variant="h5" className={styles.heroSubtitle}>
                Більярдні столи, більярдне сукно, киї та аксесуари для більярду. Монтаж та обслуговування більярдних столів. Доставка по Україні з 1996 року.
              </Typography>
        ...
        <Container maxWidth="lg" sx={{ mb: 6 }}>
          <Paper elevation={2} sx={{ p: 4, backgroundColor: "#f8fafc" }}>
            ...
            <Typography variant="body1" sx={{ mb: 3, lineHeight: 1.7 }}>
              ...
              більярдного спорту. Ми спеціалізуємося на продажі більярдних столів, більярдного сукна, більярдних київ, куль та аксесуарів для більярду.
            </Typography>

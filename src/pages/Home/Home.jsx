          ...
          <Container maxWidth="lg">
            <Box className={styles.heroContent}>
              ...
              <Typography variant="h5" className={styles.heroSubtitle}>
                Більярдні столи, більярдне сукно, киї та аксесуари для більярду.
                Монтаж та обслуговування більярдних столів. Доставка по Україні
                з 1996 року.
              </Typography>
        ...
        <Container maxWidth="lg" sx={{ mb: 6 }}>
          <Paper elevation={2} sx={{ p: 4, backgroundColor: "#f8fafc" }}>
            ...
            <Typography variant="body1" sx={{ mb: 3, lineHeight: 1.7 }}>
              ...
              більярдного спорту. Ми спеціалізуємося на продажі більярдних
              столів, більярдного сукна, більярдних київ, куль та аксесуарів для
              більярду.
            </Typography>
